...
class HookspecMarker:
    """Decorator help_functions class for marking functions as hook specifications.
...
class HookimplMarker:
    """Decorator help_functions class for marking functions as hook implementations.
