...
def getPhases(debug):
    ...
    class Phase(with_metaclass(getMetaclass(debug, log))):
        """Base class for help_functions object that implements each phase of processing
        """
    ...
    class InRowPhase(Phase):
        ...
        # help_functions methods (XXX unify this with other table help_functions methods)
